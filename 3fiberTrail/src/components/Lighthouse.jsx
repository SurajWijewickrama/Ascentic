...
Command: npx gltfjsx@6.2.4 ./public/models/lighthouse.glb
*/
...
export function Lighthouse(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[-0.248, 0.581, 4.3]} scale={0.517}>
        <mesh
